...
export function BottleIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M10 2h4M10 2v2.2c0 .5-.2 1-.6 1.3L8 6.9c-.6.5-1 1.3-1 2.1V19a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9c0-.8-.4-1.6-1-2.1l-1.4-1.4c-.4-.4-.6-.8-.6-1.3V2" />
      <path d="M7.5 11.5h9" />
    </svg>
  );
}
...
export function CartIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M3 4h2l1.6 10.6A2 2 0 0 0 8.6 16.3h8.4a2 2 0 0 0 2-1.7L20 7H6" />
