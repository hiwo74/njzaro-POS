...
export function ReceiptPage() {
  ...
  if (!sale) return <div className="p-6 text-brand-900">{t.common.loading}</div>;
  ...
  return (
    <div className="min-h-screen bg-brand-50 flex flex-col items-center py-6 px-4 pt-safe pb-safe">
      <div className="no-print flex gap-2 mb-4">
        ...
        <button
          onClick={() => navigate("/")}
          className="press px-4 py-2.5 bg-surface border border-brand-100 text-brand-900 rounded-lg font-medium"
        >
      ...
      <motion.div
        ...
        className="bg-surface shadow-lg rounded-xl p-6 w-full max-w-sm font-mono text-sm"
      >
