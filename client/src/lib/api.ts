// GitHub Pages only serves static files — it can't run the Express server —
// so in production the API has to live on a separately-hosted backend.
// Set VITE_API_URL (e.g. "https://your-backend.onrender.com/api") at build
// time once that's deployed; it falls back to the relative path for local dev.
